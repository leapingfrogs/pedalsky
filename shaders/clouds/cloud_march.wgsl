...
// The wind-field / cloud-type-grid constants and the shared density
// kernel (`ndf`, `world_to_weather_uv`, `LayerWindCache`,
// `diurnal_modulation`, `effective_cloud_type`, `sample_density_light`)
// live in `cloud_density_common.wgsl`, composed before this file so
// host-owned shadow passes share the exact same density evaluation.
